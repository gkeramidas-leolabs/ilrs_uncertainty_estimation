...
# Download files
tr.dwld_data_for_all_targets(ILRS_targets[0:1],epoch,num_days)

# Perform truth analysis
Ep_Offset, r_err_coll, i_err_coll, c_err_coll = tr.collections_of_truth_state_errors(ILRS_targets[0:1],epoch,num_days)
